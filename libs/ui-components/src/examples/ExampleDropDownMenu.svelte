...
<style lang="postcss">
  ...
  .item {
    ...
    @apply text-magnum-900 z-20 outline-none;
  ...
  .check {
    @apply text-magnum-500 absolute left-2 top-1/2;
    translate: 0 calc(-50% + 1px);
  }

  .dot {
    @apply bg-magnum-900 h-[4.75px] w-[4.75px] rounded-full;
  }

  .separator {
    @apply bg-magnum-200 m-[5px] h-[1px];
  }
