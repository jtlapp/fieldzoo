// Copied from https://github.com/zandaqo/objectid64 because that package
// is not properly exporting the Encoder class.

// MIT License. Copyright (c) 2016 Maga D. Zandaqo
...
export class Encoder {
  ...
  fromBinUUID(id: Uint8Array): string {
    ...
    return encoded + base[id[15] >> 6] + base[id[15] & 0x3f];
  }
